...
# Load the image, compress, and decompress
def huffman_image_compression(image_path):
...
original_img, decompressed_img, original_size, compressed_size = huffman_image_compression(image_path)
